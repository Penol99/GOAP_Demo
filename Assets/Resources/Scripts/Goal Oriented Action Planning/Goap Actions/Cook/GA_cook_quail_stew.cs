...
public class GA_cook_quail_stew : Scr_goap_action
{
    public GA_cook_quail_stew()
    {
        AddPrecondition(G_Actions.HAS_QUAIL_MEAT,true);
        AddPrecondition(G_Actions.HAS_CARROT,true);
        AddEffect(G_Actions.HAS_FOOD_QUAIL_STEW, true);
    ...
    public override bool PerformAction()
    {
        ...
        if (DistanceCheckObject(m_target.m_agentInteractPos, m_goapAgent.m_minRange))
        {
            ...
            Scr_food.ActivateFood(FoodType.QUAIL_STEW, ((Scr_goap_agent_bert)m_goapAgent).m_foodSlot);
